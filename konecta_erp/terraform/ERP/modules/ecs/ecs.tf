...
# ===========================
# TASK DEFINITIONS - ALL 10 SERVICES
# ===========================
...
resource "aws_ecs_task_definition" "prophet_model" {
  family                   = "${var.project_name}-prophet-model-task"
  network_mode             = "awsvpc"
  requires_compatibilities = ["FARGATE"]
  cpu                      = "256"
  memory                   = "512"
...
# ===========================
# ECS SERVICES - ALL 10 SERVICES
# ===========================

# API Gateway Service (Public, behind ALB)
...
resource "aws_ecs_service" "hr_model" {
  name            = "${var.project_name}-hr-model-service"
  cluster         = aws_ecs_cluster.main.id
...
# Prophet Model Service (AI)
resource "aws_ecs_service" "prophet_model" {
  name            = "${var.project_name}-prophet-model-service"
  cluster         = aws_ecs_cluster.main.id
...
# ===========================
# RABBITMQ & CONSUL TASK DEFINITIONS
# ===========================
